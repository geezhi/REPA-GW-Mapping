...
LOG_FILE="/efs/zixianhuang/VideoREPA/finetune/train_frozen_projector.log"
TRD_SCRIPT="/efs/zixianhuang/VideoREPA/finetune/scripts/multigpu_VideoREPA_2B_sft_frozen_projector_TRD.sh"
