...
# VideoREPA Configuration - Dual Layer Alignment
# Layer 18 (deep): Standard REPA loss (cosine similarity) for semantic alignment
# Layer 5 (shallow): Temporal difference only REPA loss for motion dynamics alignment
VideoREPA_ARGS=(
    ...
    --loss_secondary cosine_similarity_temporal_diff_only
    --proj_coeff_secondary 0.5
    --comment 'exp2_dual_layer_L18_repa_L5_temporal_diff_only'
    --learning_rate 2e-6
)
