...
# TokenMerger Alignment Configuration
# Key idea: a learnable TokenMerger (Perceiver-style cross-attention) reduces the
# student token count (30x45 -> 10x15) AND projects the feature dimension
# (1920 -> 768) in ONE module, learning token-to-token correspondence without GW.
MERGER_ALIGN_ARGS=(
    --loss merger_align
