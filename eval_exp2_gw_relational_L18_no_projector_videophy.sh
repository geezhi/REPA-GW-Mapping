...
#
# Usage:
#   bash eval_exp2_gw_relational_L18_no_projector_videophy.sh [--stage 1|2|3|all]
#
# Prerequisites:
...
# Inference model directory (use the already-merged model directly)
INFER_MODEL_DIR="${FINETUNE_DIR}/output_dir_cogvideox-t2v-gw-align_gw_relational_exp2_gw_relational_L18_no_projector"

# Output directory for generated videos (VideoPhy v1)
OUTPUT_VIDEO_DIR="${INFERENCE_DIR}/output_dir/GW_align_exp2"
...
echo "============================================"
echo "VideoREPA Exp2 GW Relational L18 No Projector - VideoPhy v1 Evaluation"
echo "Stage: ${STAGE}"
...
if [ "$STAGE" = "3" ] || [ "$STAGE" = "all" ]; then
    ...
    CSV_NAME="exp2_gw_relational_L18_no_projector_videophy"
...
"
    ...
    echo ""
    echo "========== VideoPhy v1 Results for Exp2 GW Relational L18 No Projector =========="
    echo "Checkpoint: ${EXP_DIR}/${CHECKPOINT_STEP}"
