...
DATA_ARGS=(
    # training data
    --train_data_path /efs/zixianhuang/VideoREPA/finetune/openvid/openvid_3w2.csv
...
MODEL_ARGS=(
    ...
    --model_name "cogvideox-t2v"  # ["cogvideox-t2v", cogvideo-t2v-align]
    --model_type "t2v"
    --training_type "sft"   # lora, sft
    # enable this when caching
    --precomputing
)
...
VideoREPA_ARGS=(
    ...
    --comment 'VideoREPA_2B'    # for wandb log
    --learning_rate 2e-6
)
