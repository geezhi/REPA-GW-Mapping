...
###############################################################################
# VideoREPA Exp2 - High Noise Align - VideoPhy v1 Evaluation Pipeline
#
# This script evaluates the exp2 high noise align model
# (cosine_similarity_exp2_full_data_4ep_REPA_high_noise_align, checkpoint-4000)
...
#
# Usage:
#   bash eval_exp2_high_noise_align_videophy.sh [--stage 1|2|3|all]
#
# Prerequisites:
...
INFER_MODEL_DIR="${BASE_PATH}/infer_model/cogvideox-2b-exp2-high-noise-align"

# Output directory for generated videos (VideoPhy v1)
OUTPUT_VIDEO_DIR="${INFERENCE_DIR}/output_dir/exp2_high_noise_align_videophy"
...
echo "============================================"
echo "VideoREPA Exp2 - High Noise Align - VideoPhy v1 Evaluation"
echo "Stage: ${STAGE}"
...
if [ "$STAGE" = "3" ] || [ "$STAGE" = "all" ]; then
    ...
    CSV_NAME="exp2_high_noise_align_videophy"
...
"
    ...
    echo ""
    echo "========== VideoPhy v1 Results for Exp2 High Noise Align =========="
