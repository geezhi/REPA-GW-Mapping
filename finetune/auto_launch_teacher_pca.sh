...
EVAL_LOG="/efs/zixianhuang/VideoREPA/eval_frozen_projector_exp3.log"
NEXT_SCRIPT="/efs/zixianhuang/VideoREPA/finetune/scripts/multigpu_VideoREPA_2B_sft_teacher_pca.sh"
NEXT_LOG="/efs/zixianhuang/VideoREPA/finetune/train_teacher_pca.log"
