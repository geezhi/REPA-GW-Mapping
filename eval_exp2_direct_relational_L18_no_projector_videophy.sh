...
###############################################################################
# VideoREPA Exp2 - Direct Relational L18 No Projector - VideoPhy v1 Evaluation Pipeline
#
# This script evaluates the exp2 direct_relational_L18_no_projector trained model (checkpoint-4000)
...
#
# Usage:
#   bash eval_exp2_direct_relational_L18_no_projector_videophy.sh [--stage 1|2|3|all]
#
# Prerequisites:
...
# Experiment directory (exp2: Direct relational L18 no projector, checkpoint-4000)
EXP_DIR="${BASE_PATH}/finetune/output_dir_cogvideox-t2v-direct-align_gw_relational_exp2_direct_relational_L18_no_projector"
CHECKPOINT_STEP="checkpoint-4000"

# Inference model directory (will be created)
INFER_MODEL_DIR="${BASE_PATH}/infer_model/cogvideox-2b-exp2-direct-relational-L18-no-projector"

# Output directory for generated videos (VideoPhy v1)
OUTPUT_VIDEO_DIR="${INFERENCE_DIR}/output_dir/exp2_direct_relational_L18_no_projector_videophy"
...
echo "============================================"
echo "VideoREPA Exp2 Direct Relational L18 No Projector - VideoPhy v1 Evaluation"
echo "Stage: ${STAGE}"
...
if [ "$STAGE" = "3" ] || [ "$STAGE" = "all" ]; then
    ...
    CSV_NAME="exp2_direct_relational_L18_no_projector_videophy"
...
"
    ...
    echo ""
    echo "========== VideoPhy v1 Results for Exp2 Direct Relational L18 No Projector =========="
    echo "Checkpoint: ${EXP_DIR}/${CHECKPOINT_STEP}"
