...
class CogVideoXTransformer3DModelAlign(CogVideoXTransformer3DModel, ModelMixin):
    ...
    def __init__(
        ...
        align_layer_secondary: Optional[int] = None,  # secondary alignment layer for dual-layer
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        # Extract custom VideoREPA kwargs before passing to parent
        align_layer = kwargs.pop("align_layer", 18)
        align_layer_secondary = kwargs.pop("align_layer_secondary", None)
        align_dims = kwargs.pop("align_dims", [768])
        projector_dim = kwargs.pop("projector_dim", 2048)
        ...
        try:
            ...
            config["align_layer"] = align_layer
            config["align_layer_secondary"] = align_layer_secondary
            config["align_dims"] = align_dims
            config["projector_dim"] = projector_dim
