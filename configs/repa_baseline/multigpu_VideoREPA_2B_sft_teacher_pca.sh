...
# VideoREPA Configuration - Teacher PCA (no projector, align in 1920d)
VideoREPA_ARGS=(
    ...
    --proj_coeff 0.5
    --margin 0.1
    --comment 'exp_teacher_pca_multilayer_3w2_4ep'
    --learning_rate 2e-6
    --teacher_pca_path "${BASE_PATH}/finetune/teacher_pca_matrix.pth"
)
