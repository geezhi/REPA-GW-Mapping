...
# Model Configuration
MODEL_ARGS=(
    --model_path "${BASE_PATH}/ckpt/cogvideox-5b"
...
VideoREPA_ARGS=(
    ...
    --align_models VideoMAEv2   # VideoMAEv2 (VideoREPA) VideoMAE OminiMAE VJEPA VJEPA2 | DINOv2 (REPA)
